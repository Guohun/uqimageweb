    ...
    b._createClass=function(a){
        ...
        if(c=function(a){
            ...
            for(b=0;b<a.length;b+=1)
                //a[b]&&d.push("dimple-"+a[b].toString().replace(/[0-9]/g,c));
                    a[b]&&d.push("dimple-"+a[b].toString().replace(/[^a-z0-9]/g,c));
                else d=["dimple-all"];return d.join(" ")},b._drawMarkerBacks=function(c,d,e,f,g,h){var i,j,k,l=["dimple-marker-back",g,c.keyString];
