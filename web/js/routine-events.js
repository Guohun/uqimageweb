...
d3.csv("./json/teams.csv", function (teams) {
	tms=teams;
	teamHash={};
	groupHash={};
	...
	d3.csv("./json/chapters.csv",function(chapters) {
		console.log("chapters loaded");
		chp=chapters;
		d3.csv("./json/characters.csv",function(characters) {
			...
			d3.csv("./json/events.csv",function(events) {
